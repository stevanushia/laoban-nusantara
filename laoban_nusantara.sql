...
(3,'Nasi Hainan','Nasi berbumbu putih rahasia khas laoban yang pastinya sedap dicampur ayam yang disiram bumbu coklat yang muantab.','NasiHainanPotrait.jpg',1,NULL),
(4,'Nasi Jasio','Nasi berbumbu putih rahasia khas laoban yang pastinya sedap dicampur ayam jasio bumbu merah yang tebel dan juicy!','NasiJasioPotrait.jpg',1,1),
(5,'Nasi Salted Egg','Nasi putih dengan ayam bumbu telor asin yang siap memanjakan lidah + telor sunny side up juga loh!','NasiSaltedEggPotrait.jpg',1,NULL),
(6,'Mie Laksa','Mie dengan kaldu seafood gurih dilengkapi dengan bakso sea food, udang, dan telor yang jadi favorit kaum wanita, must try!!','MieLaksaPotrait.jpg',1,NULL),
(7,'Mie Hainan','Mie berbumbu putih rahasia khas laoban yang pastinya sedap dicampur ayam jasio bumbu coklat yang muantab!','MieHainanPotrait.jpg',1,1),
...
(9,'Bubur Laoban','Bubur Special Laoban adalah bubur dengan cita rasa kaldu ayam istimewa yang lezat.','BuburLaobanPotrait.jpg',1,NULL),
(10,'Butter Kaya Toast','Favorit semua orang karena roti dan selai kayanya home made, harus cobain deh 1x seumur hidup!','KayaButterToastPotrait.jpg',2,NULL),
...
(23,'Kulit Tahu','Lapisan kulit tahu yang renyah dengan isian daging ayam yang gurih.','KulitGorengPotrait.jpg',3,NULL),
(24,'Mantau','Roti khas tiongkok yang digoreng dengan Zuzu kental maniez.','MantauPotrait1.jpg',3,NULL),
(25,'Kaki Naga','Bukan kakinya naga beneran ini Olahan daging ayam yang digoreng.','KakiNagaPotrait.jpg',3,NULL),
(26,'Gyoza','Gyoza, hidangan Jepang yg digoreng! Mirip pangsit goreng isi ayam sayur.','KakiNagaPotrait.jpg',3,NULL),
(27,'Kopi Laoban','Kopi blend robusta arabica yg pas! Sruput nendang!','KopiLaoban.jpg',4,NULL),
(28,'Kopi Susu Laoban','Rasa kekayaan kopi dan susu kental manis yang menghangatkan.','KopiSusuLaoban.jpg',4,NULL),
(29,'Teh Laoban','Teh asli malaysia dengan aroma yang menenangkan dan menghangatkan.','TehLaoban.jpg',4,NULL),
(30,'Teh Tarik','Minuman teh yang ditarik dengan susu yang menghangatkan.','TehTarik.jpg',4,NULL),
...
(32,'Kopi Butter','Sensasi kaya rasa kopi susu dengan sentuhan lembut butter yang creamy.','KopiButter.jpg',4,NULL),
(33,'Kopi Jahe','Perpaduan kopi dan jahe yang hangat dan menggugah selera para pecinta kehangatan.','KopiJahe.jpg',4,NULL),
(34,'Milo Thailand','Milo hangat creamy dengan taburan bubuk milo mirip milo dino di thailand.','MiloThailand.jpg',4,NULL),
...
(37,'Es Kopi Laoban','Kenikmatan ngopi yang segar, meningkatkan semangat dan kesegaran tubuh.','EsKopiLaoban.jpg',5,NULL),
(38,'Es Kopi Susu Laoban','Kesegaran Kopi Susu ala laoban yang memikat.','EsKopiSusu.jpg',5,NULL),
(39,'Es Teh Laoban','Kenikmatan teh khas Laoban yang dingin dan nyegerin.','EsTehLaoban.jpg',5,NULL),
(40,'Es Teh Tarik','Favorit semua orang! teh ditarik dengan susu yang pas menyegarkan!','EsTehTarik.jpg',5,NULL),
(41,'Es Kopi Rhum','Kopi blend pake sirup Rhum! ini halal ya...','EsKopiRhumPotrait.jpg',5,NULL),
(42,'Es Milo Thailand','Milo tapi lebih creamy dikasi bubuk milo lagi. Mirip milo dino yg di Thailand','EsMilo.jpg',5,NULL),
(43,'Es Burung Dara','Zeger tanpa susu dan tanpa kopi. Bersoda dan manis yg bikin fresh hari-harimu','EsBurungDara.jpg',5,NULL),
